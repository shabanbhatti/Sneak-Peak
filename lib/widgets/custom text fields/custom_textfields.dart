...
class CustomTextfieldForDialogBox extends StatefulWidget {
  CustomTextfieldForDialogBox({
    super.key,
    required this.controller,
    required this.title,
    this.prefix,
  ...
  void Function(String v)? onChanged;
  @override
  State<CustomTextfieldForDialogBox> createState() => _CustomTextfieldForDialogState();
}

class _CustomTextfieldForDialogState extends State<CustomTextfieldForDialogBox> {
  @override
  Widget build(BuildContext context) {
